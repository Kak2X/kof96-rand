...
CHAR_ID_ROULETTE EQU $28 ; Special
CHAR_ID_NONE     EQU $FF
...
MODESELECT_ACT_CPUSINGLE EQU MODE_TEAMVS+2
MODESELECT_ACT_CPUTEAM   EQU MODE_TEAMVS+3
...
CHARSEL_ID_MRKARATE0 EQU $0E
CHARSEL_ID_ROULETTE  EQU $0F
