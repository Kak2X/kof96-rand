...
wCharSelRouletteFlags1P     :db
wCharSelRouletteFlags2P     :db

CRFB_CHAR0 EQU 0 ; Team member 1 is a roulette char
CRFB_CHAR1 EQU 1 ; Team member 2 is a roulette char
CRFB_CHAR2 EQU 2 ; Team member 3 is a roulette char
CRF_CHAR0 EQU 1 << CRFB_CHAR0 ; Team member 1 is a roulette char
CRF_CHAR1 EQU 1 << CRFB_CHAR1 ; Team member 2 is a roulette char
CRF_CHAR2 EQU 1 << CRFB_CHAR2 ; Team member 3 is a roulette char
...
iPlInfo_MrKarate_RyukoRanbuD                EQU $84 ; If set, the move counts as the desperation version. The move itself doesn't use this, but the value gets passed over to Zenretsuken.
...
iPlInfo_ForceDizzy                          EQU $83 ; If set, the dizzy time is infinite until getting knocked down.
; CPU block
